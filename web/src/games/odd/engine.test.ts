...
const sample: OddExperiment[] = [
  ...
  { id:'b1', topic:'light', title:'t', prompt:'q?', type:'drag-sort', difficulty:2, config:{ categories:['A','B'], items:[{label:'x',category:'A'},{label:'y',category:'B'}] }, explanation:'e', funFact:'f' },
  { id:'b2', topic:'light', title:'t', prompt:'q?', type:'drag-sort', difficulty:2, config:{ categories:['A','B'], items:[{label:'x',category:'A'}] }, explanation:'e', funFact:'f' },
  { id:'b3', topic:'sound', title:'t', prompt:'q?', type:'drag-sort', difficulty:2, config:{ categories:['A','B'], items:[{label:'x',category:'A'}] }, explanation:'e', funFact:'f' },
  { id:'b4', topic:'sound', title:'t', prompt:'q?', type:'drag-sort', difficulty:2, config:{ categories:['A','B'], items:[{label:'x',category:'A'}] }, explanation:'e', funFact:'f' },
